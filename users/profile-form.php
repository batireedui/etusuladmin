...
$existingFiles = [
    'avatar'    => !empty($company['folder'])    ? $company['domainName'] . '/dist/uploads/company/avatar.jpg'    : null,
    'logo'      => !empty($company['folder'])      ? $company['domainName'] . '/dist/uploads/company/companylogo.jpg'      : null,
    'signature' => !empty($company['folder']) ? $company['domainName'] . '/dist/uploads/alban/sign.png' : null,
    'stamp'     => !empty($company['folder'])     ? $company['domainName'] . '/dist/uploads/alban/tamga.png'     : null,
    'blank'    => !empty($company['folder']) ? $company['domainName'] . '/dist/uploads/alban/blank1.jpg' : null,
    'ztushaal'    => !empty($company['folder'])     ? $company['domainName'] . '/dist/uploads/alban/blank2.jpg'     : null,
];
?>
<!DOCTYPE html>
<html lang="mn">
...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Noto+Sans+Mongolian&family=IBM+Plex+Sans:wght@300;400;500;600&display=swap"
        rel="stylesheet">
...
<body>
    <div class="card">
        ...
        // PHP-аас одоо байгаа зургийн замуудыг дамжуулна
        const EXISTING_FILES = <?= json_encode($existingFiles) ?>;
        </script>
        <form id="mainForm" method="POST" enctype="multipart/form-data">
            <div class="grid">
                ...
                <div class="field-group" id="group-avatar">
                    ...
                    <div class="drop-zone" id="dz-avatar" ondragover="handleDragOver(event, 'avatar')"
                        ondragleave="handleDragLeave('avatar')" ondrop="handleDrop(event, 'avatar')">
                        <input type="file" name="avatar" id="file-avatar" accept="image/*"
                            onchange="handleFileChange(this, 'avatar')">
                ...
                <div class="field-group" id="group-logo">
                    ...
                    <div class="drop-zone" id="dz-logo" ondragover="handleDragOver(event, 'logo')"
                        ondragleave="handleDragLeave('logo')" ondrop="handleDrop(event, 'logo')">
                        <input type="file" name="logo" id="file-logo" accept="image/*"
                            onchange="handleFileChange(this, 'logo')" required>
                ...
                <div class="field-group" id="group-signature">
                    ...
                    <div class="drop-zone" id="dz-signature" ondragover="handleDragOver(event, 'signature')"
                        ondragleave="handleDragLeave('signature')" ondrop="handleDrop(event, 'signature')">
                        <input type="file" name="signature" id="file-signature" accept="image/*"
                            onchange="handleFileChange(this, 'signature')" required>
                ...
                <div class="field-group" id="group-stamp">
                    ...
                    <div class="drop-zone" id="dz-stamp" ondragover="handleDragOver(event, 'stamp')"
                        ondragleave="handleDragLeave('stamp')" ondrop="handleDrop(event, 'stamp')">
                        <input type="file" name="stamp" id="file-stamp" accept="image/*"
                            onchange="handleFileChange(this, 'stamp')" required>
                ...
                <!-- Бланк -->
                <div class="field-group" id="group-blank">
                    <label class="field-label">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2">
                            <circle cx="12" cy="12" r="10" />
                    ...
                    <div class="drop-zone" id="dz-blank" ondragover="handleDragOver(event, 'blank')"
                        ondragleave="handleDragLeave('blank')" ondrop="handleDrop(event, 'blank')">
                        <input type="file" name="blank" id="file-blank" accept="image/*"
                            onchange="handleFileChange(this, 'blank')" required>
                        <div class="drop-icon" id="icon-blank">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round">
                                <rect x="3" y="3" width="18" height="18" rx="3" />
                                <circle cx="8.5" cy="8.5" r="1.5" />
                        ...
                        <div class="drop-text">
                            <div class="main-text" id="label-blank">Файл сонгох эсвэл чирж тавих</div>
                            <div class="sub-text">PNG, JPG — 5MB хүртэл</div>
                        </div>
                    </div>
                    <div class="progress-wrap" id="prog-blank">
                        <div class="progress-header">
                            <span class="progress-label">Байршуулж байна...</span>
                            <span class="progress-pct" id="pct-blank">0%</span>
                        </div>
                        <div class="progress-track">
                            <div class="progress-bar" id="bar-blank"></div>
                        </div>
                    </div>
                    <div class="preview-area" id="prev-blank">
                        <div class="preview-img-wrap">
                            <img id="img-blank" src="" alt="Бланк">
                            <span class="preview-badge" id="size-blank"></span>
                        </div>
                        <div class="upload-status" id="status-blank"></div>
                        <button type="button" class="btn-remove" id="rm-blank" onclick="removeFile('blank')">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2.5">
                                <line x1="18" y1="6" x2="6" y2="18" />
                                <line x1="6" y1="6" x2="18" y2="18" />
                ...
                <!-- Тушаал  -->
                <div class="field-group" id="group-ztushaal">
                    <label class="field-label">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2">
                            <circle cx="12" cy="12" r="10" />
                    ...
                    <div class="drop-zone" id="dz-ztushaal" ondragover="handleDragOver(event, 'ztushaal')"
                        ondragleave="handleDragLeave('ztushaal')" ondrop="handleDrop(event, 'ztushaal')">
                        <input type="file" name="ztushaal" id="file-ztushaal" accept="image/*"
                            onchange="handleFileChange(this, 'ztushaal')" required>
                        <div class="drop-icon" id="icon-ztushaal">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round">
                                <rect x="3" y="3" width="18" height="18" rx="3" />
                                <circle cx="8.5" cy="8.5" r="1.5" />
                        ...
                        <div class="drop-text">
                            <div class="main-text" id="label-ztushaal">Файл сонгох эсвэл чирж тавих</div>
                            <div class="sub-text">PNG, JPG — 5MB хүртэл</div>
                        </div>
                    </div>
                    <div class="progress-wrap" id="prog-ztushaal">
                        <div class="progress-header">
                            <span class="progress-label">Байршуулж байна...</span>
                            <span class="progress-pct" id="pct-ztushaal">0%</span>
                        </div>
                        <div class="progress-track">
                            <div class="progress-bar" id="bar-ztushaal"></div>
                        </div>
                    </div>
                    <div class="preview-area" id="prev-ztushaal">
                        <div class="preview-img-wrap">
                            <img id="img-ztushaal" src="" alt="Тушаал">
                            <span class="preview-badge" id="size-ztushaal"></span>
                        </div>
                        <div class="upload-status" id="status-ztushaal"></div>
                        <button type="button" class="btn-remove" id="rm-ztushaal" onclick="removeFile('ztushaal')">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2.5">
                                <line x1="18" y1="6" x2="6" y2="18" />
                                <line x1="6" y1="6" x2="18" y2="18" />
    ...
    function uploadFile(file, id) {
        ...
        formData.append('folder', FOLDER); // ← PHP-аас дамжуулсан утга
    ...
    function showExistingFile(id, webPath) {
        if (!webPath) return;
        ...
        // Зургийн src тохируулна
        img.src = webPath;

        // Файлын нэрийг замаас гаргаж авна
        const fileName = webPath.split('/').pop();
        label.textContent = fileName;

        // Drop zone-г "файлтай" байдалд шилжүүлнэ
        dz.classList.add('has-file');
        ...
        // Статус мэдэгдэл
        status.textContent = '✓ Өмнө байршуулсан зураг';
        status.className = 'upload-status success';

        // Зургийн хэмжээг шалгах (optional — img load болсны дараа)
        img.onload = function() {
    ...
    // ─── Хуудас бэлэн болмогц ажиллуулна ─────────────────────
    document.addEventListener('DOMContentLoaded', function() {
        // EXISTING_FILES нь PHP-аас дамжуулсан объект (existing_files_php.php харна уу)
        if (typeof EXISTING_FILES !== 'undefined') {
            Object.entries(EXISTING_FILES).forEach(function([id, path]) {
                if (path) showExistingFile(id, path);
            });
        }
    });
